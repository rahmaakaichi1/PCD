            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6">
                    <div class="login-content bg-white p-30 box-shadow">
                        ...
                        <form action="${contextPath}/connection"  method="post" name='connection'>
                            <div class="form-group ${error != null ? 'has-error' : ''}">
                                <span>${message }</span>
                                <input type="text" class="form-control" name ="username" id="username" placeholder="Nom d'utilisateur ">
                            </div>
                            <div class="form-group ${error != null ? 'has-error' : ''}">
                                <input type="password" class="form-control" id="password" name="userpassword" placeholder="Mot De Passe">
                                <span>${error }</span>
                            </div>
                            ...
                            <button type="submit" class="btn mag-btn mt-30">Connecter</button>
                            
                            <h4 class="text-center"><a href="${contextPath }/inscription">Créer un compte </a></h4>
